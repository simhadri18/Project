...
main = tkinter.Tk()
main.title("Polarity score-based Supervised Learning for Classification of Fake and Authentic Tweets using NLP") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Polarity score-based Supervised Learning for Classification of Fake and Authentic Tweets using NLP')
title.config(bg='LightSteelBlue', fg='white')  
...
cleanButton = Button(main, text="Data Preprocessing", command=clean)
